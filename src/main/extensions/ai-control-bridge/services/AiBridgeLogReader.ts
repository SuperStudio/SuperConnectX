...
export interface AiBridgeLogPathResult {
  success: boolean
  filePath?: string
  message?: string
}

export interface AiBridgeLogResolver {
  getLogFilePath: (sessionId: string) => Promise<AiBridgeLogPathResult>
}
...
export default class AiBridgeLogReader {
  constructor(private readonly resolver: AiBridgeLogResolver) {}
