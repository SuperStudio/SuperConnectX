...
import AiBridgeActivityLog from '../../src/main/extensions/ai-control-bridge/services/AiBridgeActivityLog'
...
describe('AiBridgeActivityLog', () => {
  it('writes asynchronously, rotates by size, and reads a bounded recent history', async () => {
    ...
    const log = new AiBridgeActivityLog(
