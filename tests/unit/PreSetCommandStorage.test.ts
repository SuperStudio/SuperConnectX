...
describe('PreSetCommandStorage', () => {
  ...
  beforeEach(async () => {
    ...
    const PreSetCmdMod = await import('@/main/storage/PreSetCommandStorage')
    const GroupMod = await import('@/main/storage/CommandGroupStorage')
  ...
  describe('importFromSuperCom', () => {
    ...
    it('导入带语法高亮规则的 SuperCom 文件', async () => {
      const SettingsStorageModule = await import('@/main/storage/SettingsStorage')
