...
import {
  ...
  isTftpConnection,
  isHttpConnection
} from '@/renderer/src/features/connections/protocol/index'
import type { ConnectionFormData } from '@/renderer/src/features/connections/protocol/base'
...
describe('TelnetInfo (deprecated)', () => {
  it('build 返回 telnet 默认连接', async () => {
    const { default: TelnetInfo } = await import('@/renderer/src/features/connections/protocol/TelnetInfo')
